...
{
	return call_int_hook(socket_getpeersec_stream, 0, sock, optval, optlen,
				len);
}
...
{
	return call_int_hook(tun_dev_post_create, 0, sk);
}
...
{
	int rc = call_int_hook(xfrm_decode_session, 0, skb,
				&fl->flowi_secid, 0);
