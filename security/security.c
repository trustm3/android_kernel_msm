...
{
	return call_int_hook(allow_merge_bio, 0, bio1, bio2);
}
...
{
	return call_int_hook(xfrm_state_alloc, 0, x, sec_ctx, 0);
}
				      ...
				      struct xfrm_sec_ctx *polsec, u32 secid)
{
	 ...
	 * from the sock.
	 */
	return call_int_hook(xfrm_state_alloc_acquire, 0, x, NULL, secid);
}
...
struct security_hook_heads security_hook_heads = {
	...
	.allow_merge_bio =
		LIST_HEAD_INIT(security_hook_heads.allow_merge_bio),
