...
static struct security_operations selinux_ops = {
	...
	LSM_HOOK_INIT(msg_queue_alloc_security, selinux_msg_queue_alloc_security),
	...
	LSM_HOOK_INIT(skb_owned_by, selinux_skb_owned_by),
	...
	LSM_HOOK_INIT(xfrm_state_alloc_security, selinux_xfrm_state_alloc),
	LSM_HOOK_INIT(xfrm_state_free_security, selinux_xfrm_state_free),
	LSM_HOOK_INIT(xfrm_state_delete_security, selinux_xfrm_state_delete),
	LSM_HOOK_INIT(xfrm_policy_lookup, selinux_xfrm_policy_lookup),
	LSM_HOOK_INIT(xfrm_state_pol_flow_match, selinux_xfrm_state_pol_flow_match),
